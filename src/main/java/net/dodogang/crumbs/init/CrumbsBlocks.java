...
public class CrumbsBlocks {
    ...
    public static final Block STRIPPED_CRIMSON_BUNDLED_STEM = registerPillarBlock("stripped_crimson_bundled_stem", Blocks.CRIMSON_STEM);
    public static final Block STRIPPED_WARPED_BUNDLED_STEM = registerPillarBlock("stripped_warped_bundled_stem", Blocks.WARPED_STEM);
    ...
    public static final Block CRIMSON_TILE = registerCopy("crimson_tile", Blocks.CRIMSON_PLANKS);
    ...
    public static final Block CRIMSON_TILE_SLAB = registerSlab("crimson_tile", Blocks.CRIMSON_PLANKS);
    ...
    public static final Block REINFORCED_CRIMSON_PLANKS = registerPillarBlock("reinforced_crimson_planks", Blocks.CRIMSON_STEM);
    public static final Block REINFORCED_WARPED_PLANKS = registerPillarBlock("reinforced_warped_planks", Blocks.WARPED_STEM);
    ...
    public static final Block CRIMSON_CRAFTING_TABLE = registerCraftingTable("crimson",Blocks.CRIMSON_STEM);
    public static final Block WARPED_CRAFTING_TABLE = registerCraftingTable("warped",Blocks.WARPED_STEM);
    ...
    public static final Block CRIMSON_BARREL = registerBarrel("crimson", Blocks.CRIMSON_STEM);
    public static final Block WARPED_BARREL = registerBarrel("warped", Blocks.WARPED_STEM);
    ...
    public static final Block CRIMSON_LANTERN = registerWoodLantern("crimson", Blocks.CRIMSON_STEM);
    public static final Block WARPED_LANTERN = registerWoodLantern("warped", Blocks.WARPED_STEM);
